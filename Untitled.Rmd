...
summary_table(group_by(pp_data, type_of_p), our_summary1) %>% kbt %>%
  add_header_above(header = c("Observations Level Summary over Type of Plants" = 5), bold = T, background = "#FAF33230" , font_size = 18)
#--------------------------------------------
...
summary_table(group_by(pp_data_unique, type_of_p), our_summary2) %>%
  kbt %>%
  add_header_above(header = c("Plants Level Summary over Type of Plants" = 5), bold = T,  background = "#FAF33230" , font_size = 18)
...
summary_table(group_by(pp_data_unique, city), our_summary3) %>%
  kbt %>%
  add_header_above(header = c("Plants Level Summary over City Type" = 3), bold = T, background = "#FAF33230" , font_size = 18)
#--------------------------------------------
...
summary_table(group_by(pp_data_unique, area3), our_summary4)  %>%  kbt %>%
  add_header_above(header = c("Plants Level Summary over Area" = 12), bold = T, background = "#FAF33230" , font_size = 18)
```
...
mcor <- cor(pp_data[, -c(1,2,3,6,7,8,9,10,11,12,13, 14,20, 21)])
upper <- mcor
...
xtable(upper) %>% kbt %>%
  add_header_above(header = c("Variable correlations" = 9), bold = T, background = "#FAF33230" , font_size = 18)
