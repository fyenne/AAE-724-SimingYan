...
reg1 <- lm(complete ~ big_five + spr_festival+bf_covid+area3, data = pp_data_dummy) # +as.factor(yearmon)
# felm(complete ~ big_five + spr_festival+bf_covid|area3, data = pp_data_dummy) %>% summary()


coef1 <- summary(reg1)$coef
summary(reg1)$coef %>% head(5)
```
...
reg_covid <- felm(complete ~ big_five + big_five:spr_festival + big_five:bf_covid + 
                    big_five:bf_covid:Hydro + big_five:bf_covid:wind + 
                    big_five:bf_covid:`Fossil-fuel` + big_five:bf_covid:photovoltaic| 
       as.factor(yearmon) + area3, data = pp_data_dummy) %>%
  stargazer(type = "text")
            # omit=c("big_five0:spr_festival1","big_five1:bf_covid1"))
#--------------------------------------------

mod_stargazer("regcovid.text", reg_covid,type = "text",
            omit=c("big_five0:spr_festival1","big_five1:bf_covid1"))
